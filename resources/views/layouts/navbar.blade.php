...
@endsection
@section('navBar')
<nav class="navbar    @yield('navColor')">
    <div class="container">
    ...
    <div class="nav-wrapper">
        ...
        <ul class="side-nav" id="mobile-demo">
            <li>
                <a class="navbar-brand brand-logo  white-text" href="{{ url('/') }}">
                    <IMG SRC="{{ asset('/content/logo.png')}}" WIDTH=120 HEIGHT=120>
                </a>
            </li>
            <li class=" @yield('navColor')"><a href=""></a></li>
            <li class=" @yield('navColor')"><a href=""></a></li>
            <li class=" @yield('navColor')"><a href=""></a></li>
            @yield('menu')
        </ul>

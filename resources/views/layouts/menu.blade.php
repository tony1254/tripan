...
<li class="dropdown">
	...
	<ul class="dropdown-menu">
		...
		<a href="{{ (findPermission(1))? url('/panel-de-control'): "#" }}"
			 >{{ findMenuName(1) }}</a></li>

		<li class="{{ (findPermission(2))? : "disabled" }} ">
		<a href="{{ (findPermission(2))? url('/panel-de-control'): "#" }}"
			 class="btn-block ">{{ findMenuName(2) }}</a></li>
		<li class="divider"></li>
		<li><a href="#" class="red-text"><span class="glyphicon glyphicon-log-out"></span> @lang('validation.attributes.logout')   </a></li>
	</ul>
</li>
@endif
@endsection
